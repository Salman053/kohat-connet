...
-- Combines: 001_initial_schema + 002_manual_payments + 003_content_tables
...
DO $$ BEGIN CREATE TYPE listing_status AS ENUM ('pending', 'approved', 'rejected', 'expired'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE ad_status AS ENUM ('pending', 'active', 'paused', 'completed', 'cancelled'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE ad_type AS ENUM ('banner', 'sidebar', 'featured', 'sponsored'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN ALTER TYPE payment_status ADD VALUE 'under_review' BEFORE 'completed'; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
